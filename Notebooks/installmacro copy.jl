...
# ╔═╡ 5d4a8304-0a23-11eb-3b10-5fa2db209c92
function parse_version(version_string)
		if (
			...
			as_a_string = version_string.args[3]
			version_string = :(Pkg.Types.VersionSpec($as_a_string))
		end
end
...
begin
	...
	macro install(using_expr, version_string=nothing)		
		...
		version_string = parse_version(version_string)
...
@install using JSServe

# ╔═╡ 01b34d8e-0a23-11eb-1226-c15beedc9169
JSServe.VERSION
...
# ╔═╡ 0c23b5e2-0a23-11eb-0ecc-a9c19037d946
WGLMakie.VERSION
