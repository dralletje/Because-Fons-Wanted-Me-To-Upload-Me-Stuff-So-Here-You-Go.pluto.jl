...
# ╔═╡ 6fadf636-45d0-44dc-abd0-f5f64f02ebf6
[[[[[[[[[[]]]]]]]]]]

# ╔═╡ 8365257e-e395-4898-899a-fe3bc70ac340


# ╔═╡ 7385827f-a55e-444b-9619-d2226bb542e7
import PlutoUI

# ╔═╡ 65f1d72f-9338-4348-9ae9-ed140d139ab2
@bind clock PlutoUI.Clock()

# ╔═╡ 0b5b7948-5178-45f1-9075-1576c5a598b3
# Docs.doc(Docs.Binding(PlutoUI, :Clock))

# ╔═╡ 3141e235-7331-454f-9493-c3b55d319ab7
ref = Ref(0)

# ╔═╡ eb5bf932-6603-4e8e-a0bc-6107f5007943
begin
	ref[] = ref[] + 1
	ref
end
...
# ╔═╡ c148144f-ea13-4124-913c-5fd1787dd21c
zzz = :(function X() :(...) end)

# ╔═╡ 306eccf7-5cd8-4c32-b264-0079495e3ceb
zzz.args[2].args[3] === QuoteNode(:(...))
